							...
							<div id="right-content" class="col-md-5 col-sm-8 col-xs-16">
								...
								<?php if(display_burnshows()) {
								  ...
								  <a href="https://www.amway.co.uk/our-brands/xs#tab=1" target="_blank"><img src="http://burnfm.com/wp-content/themes/burn2014/img/xs_logo.png" width ="100%" /></a>				
			                       ...
			                       <div id="twitterfeedbody" class="sidebar hidden-xs hidden-sm">
									  <?php  if(in_category('news')) {
										  $twitter = "https://twitter.com/BurnFMNews";
									  }
									  else {
										  $twitter = "https://twitter.com/Burn_FM";
									  } ?>
			                       	<a class="twitter-timeline" width="280px" data-chrome="noborders nofooter" href="<?php echo $twitter ?>"  data-widget-id="488468035724787712">Tweets by @Burn_FM</a>
